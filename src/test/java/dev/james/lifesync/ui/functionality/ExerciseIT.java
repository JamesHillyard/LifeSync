...
public class ExerciseIT extends UITestBase {
    ...
    public void testExercisePageRendered() {
        ...
        assertThat(page.getByRole(AriaRole.TAB, new Page.GetByRoleOptions().setName("View Exercise Data"))).isVisible();
        assertThat(page.getByRole(AriaRole.TAB, new Page.GetByRoleOptions().setName("Input Exercise Data"))).isVisible();
        assertThat(page.getByRole(AriaRole.TAB, new Page.GetByRoleOptions().setName("View Exercise Data"))).isEnabled();
        assertThat(page.getByRole(AriaRole.TAB, new Page.GetByRoleOptions().setName("Input Exercise Data"))).isEnabled();
